...
querystring='SELECT * FROM ist_grossps where client = "' + clientkey + '"  ORDER BY CASE WHEN media = "Display RTB" THEN "01" WHEN media = "Video - Magna Select" THEN "02" WHEN media = "Video - Magna Prime" THEN "03" WHEN media = "Mobile RTB" THEN "04" WHEN media = "Social RTB" THEN "05" WHEN media = "TV" THEN "06" WHEN media = "Display - DB Cadreon" THEN "07" WHEN media = "Video - DB Cadreon" THEN "08"  WHEN media = "Mobile - DB Cadreon" THEN "09"  WHEN media = "Social - DB Cadreon" THEN "10" WHEN media = "Display - DB Orion" THEN "11" WHEN media = "Video - DB Orion" THEN "12" WHEN media = "Mobile - DB Orion" THEN "13" WHEN media = "Social - DB Orion" THEN "14" ELSE  media END ASC,fintype,  mos';
...
querystring='SELECT * FROM ist_holdoutps where client = "' + clientkey + '" ORDER BY CASE WHEN media = "Display RTB" THEN "01" WHEN media = "Video - Magna Select" THEN "02" WHEN media = "Video - Magna Prime" THEN "03" WHEN media = "Mobile RTB" THEN "04" WHEN media = "Social RTB" THEN "05" WHEN media = "TV" THEN "06" WHEN media = "Display - DB Cadreon" THEN "07" WHEN media = "Video - DB Cadreon" THEN "08"  WHEN media = "Mobile - DB Cadreon" THEN "09"  WHEN media = "Social - DB Cadreon" THEN "10" WHEN media = "Display - DB Orion" THEN "11" WHEN media = "Video - DB Orion" THEN "12" WHEN media = "Mobile - DB Orion" THEN "13" WHEN media = "Social - DB Orion" THEN "14" ELSE  media END ASC,fintype,  mos';
...
querystring='SELECT * FROM ist_cadfee where client = "' + clientkey + '" ORDER BY CASE WHEN media = "Display RTB" THEN "01" WHEN media = "Video - Magna Select" THEN "02" WHEN media = "Video - Magna Prime" THEN "03" WHEN media = "Mobile RTB" THEN "04" WHEN media = "Social RTB" THEN "05" WHEN media = "TV" THEN "06" WHEN media = "Display - DB Cadreon" THEN "07" WHEN media = "Video - DB Cadreon" THEN "08"  WHEN media = "Mobile - DB Cadreon" THEN "09"  WHEN media = "Social - DB Cadreon" THEN "10" WHEN media = "Display - DB Orion" THEN "11" WHEN media = "Video - DB Orion" THEN "12" WHEN media = "Mobile - DB Orion" THEN "13" WHEN media = "Social - DB Orion" THEN "14" ELSE  media END ASC,fintype,  mos';
...
querystring='SELECT * FROM ist_adjbill where client = "' + clientkey + '" ORDER BY CASE WHEN media = "Display RTB" THEN "01" WHEN media = "Video - Magna Select" THEN "02" WHEN media = "Video - Magna Prime" THEN "03" WHEN media = "Mobile RTB" THEN "04" WHEN media = "Social RTB" THEN "05" WHEN media = "TV" THEN "06" WHEN media = "Display - DB Cadreon" THEN "07" WHEN media = "Video - DB Cadreon" THEN "08"  WHEN media = "Mobile - DB Cadreon" THEN "09"  WHEN media = "Social - DB Cadreon" THEN "10" WHEN media = "Display - DB Orion" THEN "11" WHEN media = "Video - DB Orion" THEN "12" WHEN media = "Mobile - DB Orion" THEN "13" WHEN media = "Social - DB Orion" THEN "14" ELSE  media END ASC,fintype,  mos';
...
querystring='SELECT * FROM ist_adjrev where client = "' + clientkey + '" ORDER BY CASE WHEN media = "Display RTB" THEN "01" WHEN media = "Video - Magna Select" THEN "02" WHEN media = "Video - Magna Prime" THEN "03" WHEN media = "Mobile RTB" THEN "04" WHEN media = "Social RTB" THEN "05" WHEN media = "TV" THEN "06" WHEN media = "Display - DB Cadreon" THEN "07" WHEN media = "Video - DB Cadreon" THEN "08"  WHEN media = "Mobile - DB Cadreon" THEN "09"  WHEN media = "Social - DB Cadreon" THEN "10" WHEN media = "Display - DB Orion" THEN "11" WHEN media = "Video - DB Orion" THEN "12" WHEN media = "Mobile - DB Orion" THEN "13" WHEN media = "Social - DB Orion" THEN "14" ELSE  media END ASC,fintype,  mos';
...
querystring='SELECT * FROM ist_adjother where client = "' + clientkey + '" ORDER BY CASE WHEN media = "Display RTB" THEN "01" WHEN media = "Video - Magna Select" THEN "02" WHEN media = "Video - Magna Prime" THEN "03" WHEN media = "Mobile RTB" THEN "04" WHEN media = "Social RTB" THEN "05" WHEN media = "TV" THEN "06" WHEN media = "Display - DB Cadreon" THEN "07" WHEN media = "Video - DB Cadreon" THEN "08"  WHEN media = "Mobile - DB Cadreon" THEN "09"  WHEN media = "Social - DB Cadreon" THEN "10" WHEN media = "Display - DB Orion" THEN "11" WHEN media = "Video - DB Orion" THEN "12" WHEN media = "Mobile - DB Orion" THEN "13" WHEN media = "Social - DB Orion" THEN "14" ELSE  media END ASC,fintype,  mos';
