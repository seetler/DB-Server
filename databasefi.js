...
connectiondb.query( "insert into action_log" + " values('" + keylog + "','"  + timelog + "','"  + ip + "','"  + dataset.servername + "','"  + dataset.client +  "','video - Magna Select')"
    , function(err, rows) {
});

logger.info("update ist_comments set comment = '" + dataset.sec2row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='video - Magna Select'");
connectiondb.query("update ist_comments set comment = '" + dataset.sec2row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='video - Magna Select'"
    , function(err, rows) {
});
...
connectiondb.query( "insert into action_log" + " values('" + keylog + "','"  + timelog + "','"  + ip + "','"  + dataset.servername + "','"  + dataset.client +  "','video - Magna Prime')"
    , function(err, rows) {
});

logger.info("update ist_comments set comment = '" + dataset.sec3row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='video - Magna Prime'");
connectiondb.query("update ist_comments set comment = '" + dataset.sec3row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='video - Magna Prime'"
    , function(err, rows) {
});
...
connectiondb.query( "insert into action_log" + " values('" + keylog + "','"  + timelog + "','"  + ip + "','"  + dataset.servername + "','"  + dataset.client +  "','Display - DB Cadreon')"
    , function(err, rows) {
});

logger.info("update ist_comments set comment = '" + dataset.sec7row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Display - DB Cadreon'");
connectiondb.query("update ist_comments set comment = '" + dataset.sec7row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Display - DB Cadreon'"
    , function(err, rows) {
});
...
connectiondb.query( "insert into action_log" + " values('" + keylog + "','"  + timelog + "','"  + ip + "','"  + dataset.servername + "','"  + dataset.client +  "','Video - DB Cadreon')"
    , function(err, rows) {
});

logger.info("update ist_comments set comment = '" + dataset.sec8row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Video - DB Cadreon'");
connectiondb.query("update ist_comments set comment = '" + dataset.sec8row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Video - DB Cadreon'"
    , function(err, rows) {
});
...
connectiondb.query( "insert into action_log" + " values('" + keylog + "','"  + timelog + "','"  + ip + "','"  + dataset.servername + "','"  + dataset.client +  "','Mobile - DB Cadreon')"
    , function(err, rows) {
});

logger.info("update ist_comments set comment = '" + dataset.sec9row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Mobile - DB Cadreon'");
connectiondb.query("update ist_comments set comment = '" + dataset.sec9row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Mobile - DB Cadreon'"
    , function(err, rows) {
});
...
connectiondb.query( "insert into action_log" + " values('" + keylog + "','"  + timelog + "','"  + ip + "','"  + dataset.servername + "','"  + dataset.client +  "','Social - DB Cadreon')"
    , function(err, rows) {
});

logger.info("update ist_comments set comment = '" + dataset.sec10row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Social - DB Cadreon'");
connectiondb.query("update ist_comments set comment = '" + dataset.sec10row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Social - DB Cadreon'"
    , function(err, rows) {
});
...
connectiondb.query( "insert into action_log" + " values('" + keylog + "','"  + timelog + "','"  + ip + "','"  + dataset.servername + "','"  + dataset.client +  "','Display - DB Orion')"
    , function(err, rows) {
});

logger.info("update ist_comments set comment = '" + dataset.sec11row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Display - DB Orion'");
connectiondb.query("update ist_comments set comment = '" + dataset.sec11row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Display - DB Orion'"
    , function(err, rows) {
});
...
connectiondb.query( "insert into action_log" + " values('" + keylog + "','"  + timelog + "','"  + ip + "','"  + dataset.servername + "','"  + dataset.client +  "','Video - DB Orion')"
    , function(err, rows) {
});

logger.info("update ist_comments set comment = '" + dataset.sec12row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Video - DB Orion'");
connectiondb.query("update ist_comments set comment = '" + dataset.sec12row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Video - DB Orion'"
    , function(err, rows) {
});
...
connectiondb.query( "insert into action_log" + " values('" + keylog + "','"  + timelog + "','"  + ip + "','"  + dataset.servername + "','"  + dataset.client +  "','Mobile - DB Orion')"
    , function(err, rows) {
});

logger.info("update ist_comments set comment = '" + dataset.sec13row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Mobile - DB Orion'");
connectiondb.query("update ist_comments set comment = '" + dataset.sec13row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Mobile - DB Orion'"
    , function(err, rows) {
});
...
connectiondb.query( "insert into action_log" + " values('" + keylog + "','"  + timelog + "','"  + ip + "','"  + dataset.servername + "','"  + dataset.client +  "','Social - DB Orion')"
    , function(err, rows) {
});


logger.info("update ist_comments set comment = '" + dataset.sec14row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Social - DB Orion'");
connectiondb.query("update ist_comments set comment = '" + dataset.sec14row1col14.replace(/'/g, '\\\''  ) + "', timelog='" + timelog + "', keylog='" + keylog + "' where client='" + dataset.client + "' and media='Social - DB Orion'"
    , function(err, rows) {
});
...
var transporter = nodemailer.createTransport({
    service: 'Gmail',
    auth: {
        user: 'cadreoninvoicerevision@gmail.com',
        pass: 'odsgvzkokuzfsuob'
            }
    });
// ----------------------------------------------
...
// ----------------------------------------------
var mailOptions = {
        from: 'cadreoninvoicerevision@gmail.com', // sender address
        to: dataset.email, // list of receivers
        bcc: 'jason.zeng@cadreon.com', // list of receivers
        subject: 'Cadreon Budget Submission: ' + dataset.servername+ ' | '+dataset.client , // Subject line
...
switch (valuecolumn) {
    case '1':
        ...
        break;
    case '2':
        datestamp =  "Video - Magna Select";
        break;
    case '3':
        datestamp =  "Video - Magna Prime";
        break;
    case '4':
    ...
    case '6':
        ...
        break;
    case '7':
        datestamp =  "Display - DB Cadreon";
        break;
    case '8':
        datestamp =  "Video - DB Cadreon";
        break;
    case '9':
        datestamp =  "Mobile - DB Cadreon";
        break;
    case '10':
        datestamp =  "Social - DB Cadreon";
        break;
    case '11':
        datestamp =  "Display - DB Orion";
        break;
    case '12':
        datestamp =  "Video - DB Orion";
        break;
    case '13':
        datestamp =  "Mobile - DB Orion";
        break;
    case '14':
        datestamp =  "Social - DB Orion";
        break;
